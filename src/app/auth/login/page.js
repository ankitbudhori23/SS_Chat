                ...
                <div className={styles.login_form_cn}>
                    <form className={styles.login_form} onSubmit={handleSubmit}>
                        ...
                        <p className={`${styles.gray}`}>
                            Login to access your studify success account.
                        </p>
                        <CustomInput type="email" id="email" field="Email" info={userInfo} handleChange={handleChange}/>
                        <CustomInput type="password" id="password" field="Password" hideOption="true" info={userInfo} handleChange={handleChange}/>
                        
                        <div className={styles.randf}>
                            <div className={`${styles.remember_me}`}>
                                <input type="checkbox" id="remember_me" name="remember_me" className={styles.custom_checkbox} onChange={handleChange}></input>
                                <p>Remember me</p>
                            </div>
